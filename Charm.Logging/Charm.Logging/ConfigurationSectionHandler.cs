 ...
 * Removed Console and Trace Logger and changed namespace.
 */
...
namespace Charm.Logging
{
    ...
    public class ConfigurationSectionHandler : IConfigurationSectionHandler
    {
        ...
        /// passed to the logger factory adapter's constructor as an <see cref="IDictionary{TKey,TValue}" />.
        /// </returns>
        private LogSetting ReadConfiguration(XmlNode section)
        {
            ...
            try
            {
                if (String.Compare(factoryTypeString, "NOOP", true) == 0)
                {
