...
using System.Xml;
using Charm.Logging.Log4net.Appenders;
using log4net;
using Moq;
...
namespace Charm.Logging.Log4net.Tests.Appenders
{
    [TestFixture]
    public class AsyncRolloverAppenderTest
    {
        ...
        [Test, Ignore("This test currently needs permissions to things it cannot have.")]
        public void WhenConfigured_RolloverLoggerIsNotified()
        {
            ...
            //var notifyLogger = (Logger)((LoggerAdapter)LogManager.GetLogger(notifyLoggerName)).Logger;
...
<log4net>
    ...
    <appender name='rollover' type='InterlineBrands.Core.Logging.AsyncRolloverAppender, InterlineBrands.Core'>
